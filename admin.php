...
$stmt = $conn->prepare("SELECT dayno, totalseatsyoucanbook, dbtablename FROM automated ORDER BY timestamp DESC LIMIT 1");
$stmt->execute();
...
<section class="filterBar">
 ...
 <div class="search-container">
    ...
    <h3><a style="text-decoration: none; font-size: 20px; color: red;"><?= $dayno ?></a></h3>
  ...
  <table style='border-collapse:collapse;'>
    ...
    <?php 
     ...
     include 'Signup/Dbconnect.php';
                        ...
                        $stmt = $conn->prepare("SELECT * FROM $dbtablename");
